...
const ModalForm = (props)=> {
    ...
    const loadFileToB64 = (file) =>new Promise((resolve,reject)=>{
    ...
    return(
        <Modal
            ...
            <Form>
                ...
                <div><Form.Label>Avatar</Form.Label></div>
                <Form.Control type="file" size="sm" onChange = {(e)=>setAvatar(e.target.files[0])}/>
            </Form.Group>
                </Form>
            </Modal.Body>
            <Modal.Footer>
